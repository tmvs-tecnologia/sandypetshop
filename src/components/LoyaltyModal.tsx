            ...
            <div className="relative bg-white rounded-[3rem] shadow-2xl w-full max-w-xl max-h-full overflow-hidden animate-[scaleIn_0.3s_ease-out] flex flex-col">
                ...
                <div className="bg-white px-8 py-6 border-t border-pink-100 shrink-0">
                    ...
                    <div className="flex items-center gap-2 bg-pink-50 rounded-2xl p-1.5 border border-pink-100">
                        ...
                        <button
                            onClick={handleCopy}
                            className={`px-4 py-2 rounded-xl text-xs font-bold transition-all flex items-center gap-2 shadow-sm whitespace-nowrap shrink-0 duration-500 ${
                                copied 
                        ...
                        >
                            {copied ? (
                                <>
                                    <ClipboardDocumentCheckIcon className="w-4 h-4 animate-[bounce_0.5s_infinite]" />
                                    Copiado
                                </>
                            ) : (
                                <>
                    ...
                    <p className="text-[10px] text-pink-300 mt-3 text-center italic uppercase tracking-tighter">Este link mostrará apenas o cartão acima para o tutor.</p>
                </div>
            </div>
