...
for (const table of tables) {
    ...
    if (table.file) {
        try {
            ...
            // Robustly find the JSON array inside the result string
            ...
            if (startIdx !== -1 && endIdx !== -1 && endIdx > startIdx) {
                ...
                throw new Error("No JSON array found in result string");
            }
        } catch (e) {
...
console.log('Dump generated successfully at .agent/supabase_dump.sql');
